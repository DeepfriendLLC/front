...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        home_badge_title: "Your private, evidence-based Mental Health app",
        home_badge_text: "Join The Revolution of Mental Health in an easy to use, safe and afforable way with Bubbles, our super whale",
        ...
        home_properties_0_0_text: "Our system is secured by our specialist psychologist. Become a better person every day with Bubbles.",
        home_properties_0_1_title: "Secure",
        home_properties_0_1_text: "Bubbles is a complex system of AIs guided by our specialist psychologist forming a large and wise whale.",
        ...
        home_properties_0_3_title: "Always with you",
        home_properties_0_3_text: "Your everyday companion, always there when you need it.",
        home_properties_0_4_title: "Affordable",
        home_properties_0_4_text: "Thanks to our system we can offer the highest quality at a lowest price than conventional therapy.",
    ...
    es: {
        ...
        home_badge_text: "Únete a La Revolución de la Salud Mental en un entorno fácil de usar, seguro y asequible de la mano de Bubbles, nuestra super ballena",
