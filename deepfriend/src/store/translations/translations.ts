...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        que_tenemos_text: "Deepfriend es tu espacio seguro para sanar donde y cuando quieras. Aquí, Bubbles estará para acompañarte y guiarte siempre que lo necesites. Es experto en TCC, la única técnica psicológica respaldada por la ciencia. Aquí podrás personalizarlo todo a tu gusto. Complementamos la terapia profesional, crea un grupo con tu psicólogo para que adapte Bubbles a tus necesidades.",
        que_tenemos_1_title: "Perfect your therapy",
        que_tenemos_1_text: "Deepfriend es tu espacio seguro para sanar donde y cuando quieras. Aquí, Bubbles estará para acompañarte y guiarte siempre que lo necesites. Es experto en TCC, la única técnica psicológica respaldada por la ciencia. Aquí podrás personalizarlo todo a tu gusto. Complementamos la terapia profesional, crea un grupo con tu psicólogo para que adapte Bubbles a tus necesidades.",
        que_tenemos_2_title: "Understand. Take control.",
        que_tenemos_2_text: "Deepfriend es tu espacio seguro para sanar donde y cuando quieras. Aquí, Bubbles estará para acompañarte y guiarte siempre que lo necesites. Es experto en TCC, la única técnica psicológica respaldada por la ciencia. Aquí podrás personalizarlo todo a tu gusto. Complementamos la terapia profesional, crea un grupo con tu psicólogo para que adapte Bubbles a tus necesidades.",
        que_tenemos_3_title: "Privacy at its finest",
        que_tenemos_3_text: "Deepfriend es tu espacio seguro para sanar donde y cuando quieras. Aquí, Bubbles estará para acompañarte y guiarte siempre que lo necesites. Es experto en TCC, la única técnica psicológica respaldada por la ciencia. Aquí podrás personalizarlo todo a tu gusto. Complementamos la terapia profesional, crea un grupo con tu psicólogo para que adapte Bubbles a tus necesidades.",
