...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        home_badge_title: "The future of Mental Health",
        home_badge_text: "Discover the best app for your Mental Health by the hand of science and Bubbles, our super whale",
        ...
        home_properties_0_1_title: "Reliable",
    ...
    es: {
        ...
        home_badge_title: "Tu app segura y científica para sanar",
        home_badge_text: "Descubre la mejor app para tu Salud Mental de la mano de la ciencia y Bubbles, nuestra super ballena",
