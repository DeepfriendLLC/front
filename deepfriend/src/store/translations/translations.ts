...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        home_badge_title: "Your safe and scientific space to heal",
        home_badge_text: "Discover the future of psychology by the hand of science and Bubbles, our super whale",
        home_badge_download: "Download now",
        home_badge_button_download_0: "Learn more",
        home_badge_button_download_1: "Download",
        home_properties_0_0_title: "Improve",
        home_properties_0_0_text: "Become a better person every day with Bubbles.",
        home_properties_0_1_title: "Not a simple chatGPT",
        ...
        home_properties_0_4_text: "Thanks to our system and technological advances, we can offer the highest quality at a reasonable price.",
        ...
        home_properties_8_title: "Try the best app for your mind for free",
    ...
    es: {
        ...
        home_badge_text: "Descubre el futuro de la psicología de la mano de la ciencia y Bubbles, nuestra super ballena",
        ...
        home_properties_0_0_text: "Conviértete en una mejor persona cada día con Bubbles.",
        home_properties_0_1_title: "No es un simple ChatGPT",
        home_properties_0_1_text: "Bubbles es un complejo sistema de IAs guiado por nuestro psicólogo especialista formando una gran y sabia ballena.",
        ...
        home_properties_0_4_text: "Gracias a nuestro sistema y a los avances tecnológicos, podemos ofrecer la máxima calidad a un precio razonable.",
        ...
        home_properties_8_title: "Prueba gratis la mejor app para tu mente",
