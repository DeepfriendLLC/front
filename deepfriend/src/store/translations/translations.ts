...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        home_badge_text: "Evidence-based Mental Health Revolution. Open. Transparent. Independent. Made for you.",
        home_badge_download: "Download now",
        home_badge_button_download_0: "Learn more",
        home_badge_button_download_1: "Try for free",
        ...
        home_properties_0_1_text: "0 data leaks protocol. We are commited to never sell or share any of your data.",
