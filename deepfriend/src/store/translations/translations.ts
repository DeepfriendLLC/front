...
export const TranslationTexts: Record<AllowedLanguagesEncodedType, Record<string, string>> = {
    en: {
        ...
        home_badge_text: "Join The Revolution of Mental Health in a safe and afforable way with Bubbles, our super whale",
    ...
    es: {
        ...
        home_badge_text: "Únete a La Revolución de la Salud Mental en un entorno seguro y asequible de la mano de Bubbles, nuestra super ballena",
