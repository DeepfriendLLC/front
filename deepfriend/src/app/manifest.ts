...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    categories: [
      "Deepfriend",
      "ia Bubbles",
      "ia cientifica salud mental",
      "ia cientifica Bubbles",
      "ia salud mental Bubbles",
      "ia cientifica salud mental Deepfriend",
      "ia cientifica salud mental Bubbles",
      "salud mental basada en la ciencia",
      "Deep friend",
      "Deep Friend",
      "app ia",
      "salud mental",
      "salud mental cientifica",
    ],
    display: "fullscreen",
